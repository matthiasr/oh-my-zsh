# grml-zsh-config as a single, monolithic Oh-My-ZSH plugin
#
# This is the ZSH configuration file of the GRML Linux distribution
# <http://grml.org/zsh>.
# Changes:
# * Prompt settings have been moved into the grml theme. 
# * sets neither bindkey -e nor bindkey -v as there is a separate plugin
#   for this
#
# This file is under the GPLv2 and (c) Michael Prokop <mika@grml.org>
